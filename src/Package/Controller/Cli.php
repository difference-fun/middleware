...
namespace Package\Difference\Fun\Middleware\Controller;
...
class Cli extends Controller {
    ...
    const INFO = [
        '{{binary()}} difference_fun/middleware              | Middleware options',
        '{{binary()}} difference_fun/middleware setup        | Middleware setup',
        '{{binary()}} difference_fun/middleware update       | Middleware update',
    ];
